#!/usr/bin/python3
"""
Exercise 6: Copy 'Rectangle' class from
exercise 5 and make a public class attribute
in it that counts the amount of instances of
'Rectangle' there are at run-time.
"""
